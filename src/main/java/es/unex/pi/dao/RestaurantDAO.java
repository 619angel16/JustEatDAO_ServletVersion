...
public interface RestaurantDAO {
	 ...
	 * @return List of all the restaurants from the database that contain a text either in the name.
	 */
	public List<Restaurant> getAllByCity(String search);

	/**
	 * Gets all the restaurants from the database that belong to a category.
	 *
	 * @param idct
	 *            id category .
	 *
	 * @return List of all the restaurants from the database that belong to a category.
	 */
	public List<Restaurant> getAllByCategory(Long idct);
